...
describe Temperature do
  ...
  describe "utility class methods" do
	it "at freezing in celsius with ftoc" do
        Temperature.ftoc(32).should == 0
    end

    it "at boiling in celsius with ftoc" do
        Temperature.ftoc(212).should == 100
    end
	
	it "at freezing in fahrenheit with ctof" do
		Temperature.ctof(0).should == 32
    end

    it "at boiling in fahrenheit with ctof" do
